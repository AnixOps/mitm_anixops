...
require_pattern "$RELEASE_GATE_DOC" "ci-workflow-production-mitm-roadmap-gate=scripts/production-mitm-roadmap-check.sh" "release gate missing CI production MITM roadmap marker"
...
require_pattern "$RELEASE_GATE_DOC" "release-workflow-production-mitm-roadmap-gate=scripts/production-mitm-roadmap-check.sh" "release gate missing release production MITM roadmap marker"
...
require_pattern "$RELEASE_DRY_RUN_DOC" "release-dry-run-production-mitm-roadmap-gate=scripts/production-mitm-roadmap-check.sh" "release dry-run contract missing production MITM roadmap marker"
