...
check_common_workflow_metadata() {
	...
	require_pattern "$file" "Feature additions:" "$label notes missing feature additions section"
	require_pattern "$file" "BUG fixes:" "$label notes missing BUG fixes section"
...
require_pattern "$RELEASE_DRY_RUN_DOC" "release-dry-run-notes-change-summary=feature-additions-and-bug-fixes" "dry-run contract missing release notes change summary marker"
...
require_pattern "$RELEASE_DRY_RUN_DOC" "release notes omit feature additions, BUG fixes" "dry-run contract missing release notes change summary failure rule"
...
require_pattern "$RELEASE_GATE_DOC" "release-workflow-notes-change-summary=feature-additions-and-bug-fixes" "release gate missing release notes change summary marker"
...
require_pattern "$RELEASE_GATE_DOC" "release notes omit feature additions, BUG fixes, compatibility scope, known gaps, or rollback path" "release gate missing notes blocking condition"
