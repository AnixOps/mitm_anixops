...
assert_contains "4. Apply request body rewrites with \`anixops_rewrite_apply_body\` after buffering plain text."
...
assert_contains "3. Apply response body rewrites with \`anixops_rewrite_apply_body\` after plain-text decoding."
