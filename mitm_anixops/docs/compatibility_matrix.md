...
| Loon rule reject | `[Rule]` `URL-REGEX,<pattern>,REJECT`, `DOMAIN,<host>,REJECT`, `DOMAIN-KEYWORD,<keyword>,REJECT`, `DOMAIN-SUFFIX,<host>,REJECT`, `FINAL,REJECT` | Supported parser/reject-intent subset | `Loon.RuleDomainReject.plugin`, `Loon.RuleDomainReject.Malformed.plugin`, `Loon.RuleDomainExactReject.plugin`, `Loon.RuleDomainExactReject.Malformed.plugin`, `Loon.RuleDomainKeywordReject.plugin`, `Loon.RuleDomainKeywordReject.Malformed.plugin`, `Loon.RuleFinalReject.plugin`, `Loon.RuleFinalReject.Malformed.plugin`, `Loon.RuleUrlRegexReject.plugin`, `Loon.RuleUrlRegexReject.Malformed.plugin`, `config/loon_rule_domain_reject_fixture_maps_domain_suffix_rejects`, `config/loon_rule_domain_exact_reject_fixture_maps_exact_domain_rejects`, `config/loon_rule_domain_keyword_reject_fixture_maps_domain_keyword_rejects`, `config/loon_rule_final_reject_fixture_maps_final_reject`, `config/loon_rule_url_regex_reject_fixture_maps_url_regex_rejects`, `config/loon_rule_domain_reject_malformed_fixture_rejects_invalid_domain`, `config/loon_rule_domain_exact_reject_malformed_fixture_rejects_invalid_domain`, `config/loon_rule_domain_keyword_reject_malformed_fixture_rejects_invalid_keyword`, `config/loon_rule_final_reject_malformed_fixture_rejects_missing_action`, `config/loon_rule_url_regex_reject_malformed_fixture_rejects_invalid_regex`; direct/proxy route selection remains adapter-owned |
| Loon rule route-selection guard | `[Rule]` `DIRECT`/`PROXY`, `IP-CIDR`, `GEOIP`, `no-resolve` | Unsupported route/DNS guard | `Loon.RuleRouteUnsupported.plugin`, `config/loon_rule_route_unsupported_fixture_keeps_routes_ignored`; route selection remains adapter-owned |
| Loon rewrite aliases | `[URL Rewrite]`, `[Remote Rewrite]` | Supported parser/request-and-response-rewrite subset | `config_accepts_section_aliases_and_crlf`, `Loon.RequestRewrite.plugin`, `Loon.RequestRewrite.Malformed.plugin`, `Loon.ResponseRewrite.plugin`, `Loon.ResponseRewrite.Malformed.plugin`, `config/loon_request_rewrite_fixture_maps_redirect_and_reject`, `config/loon_request_rewrite_malformed_fixture_rejects_invalid_url_regex`, `config/loon_response_rewrite_fixture_maps_response_echo_and_body`, `config/loon_response_rewrite_malformed_fixture_rejects_invalid_body_regex` |
| Loon body rewrite aliases | `[Body Rewrite]`, `[Remote Body Rewrite]` | Supported parser/body-mutation subset | `config_accepts_body_rewrite_section_aliases`, `Loon.BodyMutation.plugin`, `Loon.BodyMutation.Malformed.plugin`, `Loon.BodyJsonMutation.plugin`, `Loon.BodyJsonMutation.Malformed.plugin`, `Loon.ResponseBodyJsonMutation.plugin`, `Loon.ResponseBodyJsonMutation.Malformed.plugin`, `config/loon_body_mutation_fixture_maps_body_rewrites`, `config/loon_body_mutation_malformed_fixture_rejects_invalid_body_regex`, `config/loon_body_json_mutation_fixture_maps_request_body_json_replace`, `config/loon_body_json_mutation_malformed_fixture_rejects_missing_json_path`, `config/loon_response_body_json_mutation_fixture_maps_response_body_json_replace`, `config/loon_response_body_json_mutation_malformed_fixture_rejects_missing_json_path` |
| Loon header rewrite aliases | `[Header Rewrite]`, `[Remote Header Rewrite]` | Supported parser/header-mutation subset | `config_accepts_header_rewrite_section_aliases`, `Loon.HeaderMutation.plugin`, `Loon.HeaderMutation.Malformed.plugin`, `config/loon_header_mutation_fixture_maps_header_rewrites`, `config/loon_header_mutation_malformed_fixture_rejects_invalid_header_regex` |
...
| Surge module | `[Script]` plus `name = type=http-response, pattern=...` and `[URL Rewrite]` request/body/header subset | Supported subset | `surge_style_script_rule_template_is_supported`, representative Surge fixture, `Surge.RequestRewrite.sgmodule`, `Surge.RequestRewrite.Malformed.sgmodule`, `Surge.ResponseRewrite.sgmodule`, `Surge.ResponseRewrite.Malformed.sgmodule`, `Surge.BodyMutation.sgmodule`, `Surge.BodyMutation.Malformed.sgmodule`, `Surge.BodyJsonMutation.sgmodule`, `Surge.BodyJsonMutation.Malformed.sgmodule`, `Surge.HeaderMutation.sgmodule`, `Surge.HeaderMutation.Malformed.sgmodule`, `config/surge_request_rewrite_fixture_maps_redirect_and_reject`, `config/surge_request_rewrite_malformed_fixture_rejects_invalid_url_regex`, `config/surge_response_rewrite_fixture_maps_response_body_regex`, `config/surge_response_rewrite_malformed_fixture_rejects_invalid_body_regex`, `config/surge_body_mutation_fixture_maps_response_body_regex`, `config/surge_body_mutation_malformed_fixture_rejects_invalid_regex`, `config/surge_body_json_mutation_fixture_maps_response_body_json_replace`, `config/surge_body_json_mutation_malformed_fixture_rejects_missing_json_path`, `config/surge_header_mutation_fixture_maps_header_rewrites`, `config/surge_header_mutation_malformed_fixture_rejects_invalid_header_regex` |
...
| Stash URL rewrite request policy | YAML `http.url-rewrite` `pattern - reject` and `pattern replacement 301/302/303/307/308` | Supported parser/reject and redirect-intent subset | `Stash.UrlRewrite.yaml`, `Stash.UrlRewrite.Malformed.yaml`, `Stash.UrlRewriteRedirect.yaml`, `Stash.UrlRewriteRedirect.Malformed.yaml`, `Stash.UrlRewriteRedirectStatus.yaml`, `Stash.UrlRewriteRedirectStatus.Malformed.yaml`, `config/stash_url_rewrite_fixture_maps_reject_subset`, `config/stash_url_rewrite_malformed_fixture_rejects_invalid_regex`, `config/stash_url_rewrite_redirect_fixture_maps_redirect_subset`, `config/stash_url_rewrite_redirect_malformed_fixture_rejects_invalid_regex`, `config/stash_url_rewrite_redirect_status_fixture_maps_portable_redirects`, `config/stash_url_rewrite_redirect_status_malformed_fixture_rejects_invalid_regex`; transparent and direct/proxy route selection remain migration-guarded |
| Shadowrocket common config | `[URL Rewrite]`, `[Script]`, `[MITM]` | Supported subset | `Shadowrocket.CommonConfig.conf`, `Shadowrocket.CommonConfig.Malformed.conf`, `Shadowrocket.RequestRewrite.conf`, `Shadowrocket.RequestRewrite.Malformed.conf`, `config/shadowrocket_common_config_fixture_is_supported`, `config/shadowrocket_common_config_fixture_rejects_invalid_regex`, `config/shadowrocket_request_rewrite_fixture_maps_redirect_and_reject`, `config/shadowrocket_request_rewrite_malformed_fixture_rejects_invalid_url_regex` |
...
| Quantumult X `url`-prefixed redirect/reject/body/header/echo-response rewrites | Supported subset | `quantumultx_url_prefixed_rewrites_are_supported`, `quantumultx_echo_response_is_supported`, `QuantumultX.RequestRewrite.snippet`, `QuantumultX.RequestRewrite.Malformed.snippet`, `QuantumultX.ResponseRewrite.snippet`, `QuantumultX.ResponseRewrite.Malformed.snippet`, `QuantumultX.EchoResponse.snippet`, `QuantumultX.EchoResponse.Malformed.snippet`, `QuantumultX.BodyMutation.snippet`, `QuantumultX.BodyMutation.Malformed.snippet`, `QuantumultX.HeaderAdd.snippet`, `QuantumultX.HeaderAdd.Malformed.snippet`, `QuantumultX.HeaderReplace.snippet`, `QuantumultX.HeaderReplace.Malformed.snippet`, `QuantumultX.ResponseHeaderAdd.snippet`, `QuantumultX.ResponseHeaderAdd.Malformed.snippet`, `QuantumultX.ResponseHeaderReplace.snippet`, `QuantumultX.ResponseHeaderReplace.Malformed.snippet`, `QuantumultX.ResponseHeaderDelete.snippet`, `QuantumultX.ResponseHeaderDelete.Malformed.snippet`, `QuantumultX.HeaderMutation.snippet`, `QuantumultX.HeaderMutation.Malformed.snippet`, `QuantumultX.RequestHeaderMutation.snippet`, `QuantumultX.RequestHeaderMutation.Malformed.snippet`, `QuantumultX.HeaderDelete.snippet`, `QuantumultX.HeaderDelete.Malformed.snippet`, `config/quantumultx_request_rewrite_fixture_maps_redirect_and_reject`, `config/quantumultx_request_rewrite_malformed_fixture_rejects_invalid_url_regex`, `config/quantumultx_response_rewrite_fixture_maps_response_echo_and_body`, `config/quantumultx_response_rewrite_malformed_fixture_rejects_invalid_body_regex`, `config/quantumultx_echo_response_fixture_maps_response_body`, `config/quantumultx_echo_response_malformed_fixture_rejects_missing_body`, `config/quantumultx_body_mutation_fixture_maps_response_body_regex`, `config/quantumultx_body_mutation_malformed_fixture_rejects_invalid_regex`, `config/quantumultx_header_add_fixture_maps_request_header_add`, `config/quantumultx_header_add_malformed_fixture_rejects_missing_header_name`, `config/quantumultx_header_replace_fixture_maps_request_header_replace`, `config/quantumultx_header_replace_malformed_fixture_rejects_missing_header_name`, `config/quantumultx_response_header_add_fixture_maps_response_header_add`, `config/quantumultx_response_header_add_malformed_fixture_rejects_missing_header_name`, `config/quantumultx_response_header_replace_fixture_maps_response_header_replace`, `config/quantumultx_response_header_replace_malformed_fixture_rejects_missing_header_name`, `config/quantumultx_response_header_delete_fixture_maps_response_header_delete`, `config/quantumultx_response_header_delete_malformed_fixture_rejects_missing_header_name`, `config/quantumultx_header_mutation_fixture_maps_response_header_regex`, `config/quantumultx_header_mutation_malformed_fixture_rejects_invalid_regex`, `config/quantumultx_request_header_mutation_fixture_maps_request_header_regex`, `config/quantumultx_request_header_mutation_malformed_fixture_rejects_invalid_regex`, `config/quantumultx_header_delete_fixture_maps_request_header_delete`, `config/quantumultx_header_delete_malformed_fixture_rejects_missing_header_name` |
...
| Request header add/replace/delete/regex replace | Supported as structured operation | `anixops_rewrite_evaluate_header`, `Loon.HeaderMutation.plugin`, `Surge.HeaderMutation.sgmodule`, `config/loon_header_mutation_fixture_maps_header_rewrites`, `config/surge_header_mutation_fixture_maps_header_rewrites` |
| Response header add/replace/delete/regex replace | Supported as structured operation | `anixops_rewrite_evaluate_header`, `Loon.HeaderMutation.plugin`, `Surge.HeaderMutation.sgmodule`, `config/loon_header_mutation_fixture_maps_header_rewrites`, `config/loon_header_mutation_malformed_fixture_rejects_invalid_header_regex`, `config/surge_header_mutation_fixture_maps_header_rewrites`, `config/surge_header_mutation_malformed_fixture_rejects_invalid_header_regex` |
