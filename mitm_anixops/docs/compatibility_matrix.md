...
| Loon argument section | `[Argument]` `Name = kind,default` | Supported parser/default subset | `Loon.ArgumentSection.plugin`, `Loon.ArgumentSection.Malformed.plugin`, `config/loon_argument_section_fixture_resolves_script_defaults`, `config/loon_argument_section_malformed_fixture_rejects_missing_separator` |
