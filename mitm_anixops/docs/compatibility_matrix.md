...
| Request header add/replace/delete/regex replace | Supported as structured operation | `anixops_rewrite_evaluate_header`, `Surge.HeaderMutation.sgmodule`, `config/surge_header_mutation_fixture_maps_header_rewrites` |
| Response header add/replace/delete/regex replace | Supported as structured operation | `anixops_rewrite_evaluate_header`, `Surge.HeaderMutation.sgmodule`, `config/surge_header_mutation_fixture_maps_header_rewrites`, `config/surge_header_mutation_malformed_fixture_rejects_invalid_header_regex` |
