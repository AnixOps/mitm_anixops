...
| Loon rewrite aliases | `[URL Rewrite]`, `[Remote Rewrite]` | Supported parser/request-rewrite subset | `config_accepts_section_aliases_and_crlf`, `Loon.RequestRewrite.plugin`, `Loon.RequestRewrite.Malformed.plugin`, `config/loon_request_rewrite_fixture_maps_redirect_and_reject`, `config/loon_request_rewrite_malformed_fixture_rejects_invalid_url_regex` |
