...
| Loon body rewrite aliases | `[Body Rewrite]`, `[Remote Body Rewrite]` | Supported parser/body-mutation subset | `config_accepts_body_rewrite_section_aliases`, `Loon.BodyMutation.plugin`, `Loon.BodyMutation.Malformed.plugin`, `Loon.BodyJsonMutation.plugin`, `Loon.BodyJsonMutation.Malformed.plugin`, `config/loon_body_mutation_fixture_maps_body_rewrites`, `config/loon_body_mutation_malformed_fixture_rejects_invalid_body_regex`, `config/loon_body_json_mutation_fixture_maps_request_body_json_replace`, `config/loon_body_json_mutation_malformed_fixture_rejects_missing_json_path` |
