...
| Surge module | `[Script]` plus `name = type=http-response, pattern=...` and `[URL Rewrite]` body/header mutation subset | Supported subset | `surge_style_script_rule_template_is_supported`, representative Surge fixture, `Surge.BodyMutation.sgmodule`, `Surge.BodyMutation.Malformed.sgmodule`, `Surge.BodyJsonMutation.sgmodule`, `Surge.BodyJsonMutation.Malformed.sgmodule`, `Surge.HeaderMutation.sgmodule`, `Surge.HeaderMutation.Malformed.sgmodule`, `config/surge_body_mutation_fixture_maps_response_body_regex`, `config/surge_body_mutation_malformed_fixture_rejects_invalid_regex`, `config/surge_body_json_mutation_fixture_maps_response_body_json_replace`, `config/surge_body_json_mutation_malformed_fixture_rejects_missing_json_path`, `config/surge_header_mutation_fixture_maps_header_rewrites`, `config/surge_header_mutation_malformed_fixture_rejects_invalid_header_regex` |
