...
third-party-plugin-corpus-license-confirmation-evidence=not-yet-confirmed
...
ca-root-generation-policy-confirmation-evidence=not-yet-confirmed
...
platform-certificate-store-confirmation-evidence=not-yet-confirmed
...
protected-runtime-environment-confirmation-evidence=not-yet-confirmed
...
mitm-signing-materials-confirmation-evidence=not-yet-confirmed
...
windows-signing-confirmation-evidence=not-yet-confirmed
...
macos-signing-notarization-confirmation-evidence=not-yet-confirmed
...
ios-network-extension-confirmation-evidence=not-yet-confirmed
...
certificate-trust-ux-confirmation-evidence=not-yet-confirmed
...
networkcore-v1-adapter-boundary-confirmation-evidence=not-yet-confirmed
...
route-selection-adapter-confirmation-evidence=not-yet-confirmed
...
adapter-redaction-implementation-confirmation-evidence=not-yet-confirmed
...
task-scheduler-runtime-confirmation-evidence=not-yet-confirmed
...
stash-expanded-parser-support-confirmation-evidence=not-yet-confirmed
...
shadowrocket-expanded-parser-support-confirmation-evidence=not-yet-confirmed
