...
- Quantumult X `url response-body-replace-regex pattern replacement`
  response-body forms;
- Quantumult X `url header-add header value` request header forms;
- Quantumult X `url header-replace header value` request header forms;
...
- Quantumult X `url response-header-replace header value` response header
  forms;
- Quantumult X `url response-header-del header` response header forms;
- Quantumult X
...
- positive fixture `tests/fixtures/QuantumultX.ResponseHeaderReplace.snippet`;
- positive fixture `tests/fixtures/QuantumultX.ResponseHeaderDelete.snippet`;
...
- positive fixture `tests/fixtures/HeaderRequestRegexMutation.Common.conf`;
...
- negative fixture `tests/fixtures/HeaderRequestRegexMutation.Common.Malformed.conf`;
