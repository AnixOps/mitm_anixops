...
static void quantumultx_body_mutation_fixture_maps_response_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.BodyMutation.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body.common.qx.test/clean",
			ANIXOPS_PHASE_REQUEST,
			"ad=1&ok=1",
			body,
			sizeof(body),
		...
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_NONE);
	ANIXOPS_EXPECT_STREQ(body, "ad=1&ok=1");
...
static void quantumultx_body_mutation_malformed_fixture_rejects_invalid_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.BodyMutation.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_header_add_fixture_maps_request_header_add(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.HeaderAdd.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.add.qx.test/trace/fast",
			ANIXOPS_PHASE_RESPONSE,
			0,
			NULL,
			&header),
	...
	ANIXOPS_EXPECT_STREQ(header.value, "trace-fast");
...
static void quantumultx_header_add_malformed_fixture_rejects_missing_header_name(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.HeaderAdd.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_header_replace_fixture_maps_request_header_replace(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.HeaderReplace.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.replace.qx.test/mode/fast",
			ANIXOPS_PHASE_RESPONSE,
			0,
			NULL,
			&header),
...
static void quantumultx_header_replace_malformed_fixture_rejects_missing_header_name(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.HeaderReplace.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_response_header_add_fixture_maps_response_header_add(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseHeaderAdd.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.response-add.qx.test/trace/fast",
			ANIXOPS_PHASE_REQUEST,
			0,
			NULL,
			&header),
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			...
			&header),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(header.action, ANIXOPS_REWRITE_RESPONSE_HEADER_ADD);
	ANIXOPS_EXPECT_EQ_INT(header.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(header.header_name, "X-Trace");
	ANIXOPS_EXPECT_STREQ(header.value, "resp-fast");
	ANIXOPS_EXPECT_STREQ(header.message, "header rewrite matched");
...
static void quantumultx_response_header_add_malformed_fixture_rejects_missing_header_name(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseHeaderAdd.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_response_header_replace_fixture_maps_response_header_replace(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseHeaderReplace.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.response-replace.qx.test/mode/fast",
			ANIXOPS_PHASE_REQUEST,
			0,
			NULL,
			&header),
...
static void quantumultx_response_header_replace_malformed_fixture_rejects_missing_header_name(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseHeaderReplace.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_response_header_delete_fixture_maps_response_header_delete(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseHeaderDelete.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.response-delete.qx.test/drop",
			ANIXOPS_PHASE_REQUEST,
			0,
			NULL,
			&header),
...
static void quantumultx_response_header_delete_malformed_fixture_rejects_missing_header_name(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseHeaderDelete.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_header_mutation_fixture_maps_response_header_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.HeaderMutation.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.common.qx.test/mode",
			ANIXOPS_PHASE_REQUEST,
			0,
			"old=Fast",
			&header),
...
static void quantumultx_header_mutation_malformed_fixture_rejects_invalid_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.HeaderMutation.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_request_header_mutation_fixture_maps_request_header_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.RequestHeaderMutation.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://header.request.qx.test/token",
			ANIXOPS_PHASE_RESPONSE,
			0,
			"old=Fast",
			&header),
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			...
			&header),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(header.action, ANIXOPS_REWRITE_HEADER_REPLACE_REGEX);
	ANIXOPS_EXPECT_EQ_INT(header.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(header.header_name, "X-Token");
	ANIXOPS_EXPECT_STREQ(header.value, "new=Fast");
	ANIXOPS_EXPECT_STREQ(header.message, "header rewritten");
...
static void quantumultx_request_header_mutation_malformed_fixture_rejects_invalid_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.RequestHeaderMutation.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void surge_body_mutation_fixture_maps_response_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.BodyMutation.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body.common.surge.test/clean",
			ANIXOPS_PHASE_REQUEST,
			"ad=1&ok=1",
			body,
			sizeof(body),
...
static void surge_body_mutation_malformed_fixture_rejects_invalid_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.BodyMutation.Malformed.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void surge_body_jq_mutation_fixture_maps_request_and_response_jq(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.BodyJqMutation.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			...
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REQUEST_BODY_JQ);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 0);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, ".enabled = true");
#if defined(ANIXOPS_ENABLE_LIBJQ)
	ANIXOPS_EXPECT_STREQ(rewrite.message, "jq body rewritten");
	ANIXOPS_EXPECT_STREQ(body, "{\"enabled\":true}");
#else
	ANIXOPS_EXPECT_STREQ(rewrite.message, "jq backend unavailable");
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			...
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_RESPONSE_BODY_JQ);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 200);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 1);
	ANIXOPS_EXPECT_STREQ(rewrite.value, ".enabled = false");
#if defined(ANIXOPS_ENABLE_LIBJQ)
	ANIXOPS_EXPECT_STREQ(rewrite.message, "jq body rewritten");
	ANIXOPS_EXPECT_STREQ(body, "{\"enabled\":false}");
#else
...
static void surge_body_jq_mutation_malformed_fixture_rejects_missing_filter(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.BodyJqMutation.Malformed.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void surge_header_mutation_fixture_maps_header_rewrites(void)
{
	...
	static const char *urls[] = {
		"https://header.surge.test/request-add/fast",
		"https://header.surge.test/request-replace/blue",
		"https://header.surge.test/request-drop",
		"https://header.surge.test/request-regex",
		"https://header.surge.test/response-add/cache",
		"https://header.surge.test/response-replace/green",
		"https://header.surge.test/response-drop",
		"https://header.surge.test/response-regex"};
	...
	static const char *current_values[] = {
		...
		NULL,
		"old=Beta"};
	char *fixture = read_fixture("tests/fixtures/Surge.HeaderMutation.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	size_t i;
...
static void surge_header_mutation_malformed_fixture_rejects_invalid_header_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.HeaderMutation.Malformed.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void request_rewrite_redirect_status_common_fixture_maps_portable_statuses(void)
{
	char *fixture = read_fixture("tests/fixtures/RequestRewrite.RedirectStatus.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	size_t i;
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"http://status.request.rewrite.test/permanent/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_301);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 301);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://permanent.request.rewrite.test/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://status.request.rewrite.test/temporary/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 1);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://temporary.request.rewrite.test/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://status.request.rewrite.test/preserve/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_308);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 308);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 2);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://preserve.request.rewrite.test/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");
...
static void loon_request_rewrite_fixture_maps_redirect_and_reject(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.RequestRewrite.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	size_t i;
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"http://request.loon.test/old/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://request.loon.test/new/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://request.loon.test/ads",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REJECT_200);
...
static void loon_request_rewrite_malformed_fixture_rejects_invalid_url_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.RequestRewrite.Malformed.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_request_rewrite_fixture_maps_redirect_and_reject(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.RequestRewrite.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	size_t i;
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://request.qx.test/new/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://request.qx.test/ads",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REJECT_200);
...
static void quantumultx_request_rewrite_malformed_fixture_rejects_invalid_url_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.RequestRewrite.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void surge_request_rewrite_fixture_maps_redirect_and_reject(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.RequestRewrite.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	size_t i;
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"http://request.surge.test/old/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://request.surge.test/new/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://request.surge.test/ads",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REJECT_200);
...
static void surge_request_rewrite_malformed_fixture_rejects_invalid_url_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.RequestRewrite.Malformed.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void shadowrocket_request_rewrite_fixture_maps_redirect_and_reject(void)
{
	char *fixture = read_fixture("tests/fixtures/Shadowrocket.RequestRewrite.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	size_t i;
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"http://request.shadowrocket.test/old/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 302);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://request.shadowrocket.test/new/item");
	ANIXOPS_EXPECT_STREQ(rewrite.message, "rewrite matched");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://request.shadowrocket.test/ads",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REJECT_200);
...
static void shadowrocket_request_rewrite_malformed_fixture_rejects_invalid_url_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Shadowrocket.RequestRewrite.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void stash_url_rewrite_redirect_status_fixture_maps_portable_redirects(void)
{
	char *fixture = read_fixture("tests/fixtures/Stash.UrlRewriteRedirectStatus.yaml");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"http://stash-status.example.test/permanent/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_301);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 301);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://edge.stash-status.example.test/item");
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://stash-status.example.test/see/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_303);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 303);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://see.stash-status.example.test/item");
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 1);

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_url(
			engine,
			"https://stash-status.example.test/preserve/item",
			ANIXOPS_PHASE_REQUEST,
			&rewrite),
		ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REDIRECT_308);
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 308);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "https://preserve.stash-status.example.test/item");
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 2);
...
static void stash_url_rewrite_redirect_status_malformed_fixture_rejects_invalid_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Stash.UrlRewriteRedirectStatus.Malformed.yaml");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void shadowrocket_body_mutation_fixture_maps_response_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Shadowrocket.BodyMutation.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body.shadowrocket.test/clean",
			ANIXOPS_PHASE_REQUEST,
			"ad=1&ok=1",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 200);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.message, "body rewritten");
	ANIXOPS_EXPECT_STREQ(body, "clean=1&ok=1");
...
static void shadowrocket_body_mutation_malformed_fixture_rejects_invalid_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Shadowrocket.BodyMutation.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void shadowrocket_response_rewrite_fixture_maps_mock_response_body(void)
{
	char *fixture = read_fixture("tests/fixtures/Shadowrocket.ResponseRewrite.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://response.shadowrocket.test/mock/item",
			ANIXOPS_PHASE_REQUEST,
			"original",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 200);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "shadowrocket-item");
	ANIXOPS_EXPECT_STREQ(body, "shadowrocket-item");

	anixops_engine_free(engine);
	free(fixture);
}

static void shadowrocket_response_rewrite_malformed_fixture_rejects_missing_body(void)
{
	char *fixture = read_fixture("tests/fixtures/Shadowrocket.ResponseRewrite.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void header_request_regex_mutation_common_fixture_maps_request_header_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/HeaderRequestRegexMutation.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	ANIXOPS_EXPECT_TRUE(fixture != NULL);
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_evaluate_header(
			engine,
			"https://request-header-regex.mutation.test/token",
			ANIXOPS_PHASE_RESPONSE,
			0,
			"old=Fast",
			&header),
...
static void header_request_regex_mutation_common_fixture_rejects_invalid_header_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/HeaderRequestRegexMutation.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void header_response_mutation_common_fixture_maps_response_header_add_replace(void)
{
	static const char *urls[] = {
		"https://response-header.mutation.test/add/fast",
		"https://response-header.mutation.test/replace/slow"};
	static const anixops_rewrite_action_t actions[] = {
		ANIXOPS_REWRITE_RESPONSE_HEADER_ADD,
		ANIXOPS_REWRITE_RESPONSE_HEADER_REPLACE};
	static const char *expected_names[] = {"X-Trace", "X-Mode"};
	static const char *expected_values[] = {"resp-fast", "resp-slow"};
	char *fixture = read_fixture("tests/fixtures/HeaderResponseMutation.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	size_t i;
	...
	for (i = 0; i < 2; i++) {
		...
		ANIXOPS_EXPECT_EQ_INT(
			anixops_rewrite_evaluate_header(engine, urls[i], ANIXOPS_PHASE_REQUEST, 0, NULL, &header),
			ANIXOPS_OK);
		ANIXOPS_EXPECT_EQ_INT(header.action, ANIXOPS_REWRITE_NONE);
		ANIXOPS_EXPECT_EQ_INT(header.rule_index, -1);

		ANIXOPS_EXPECT_EQ_INT(
			anixops_rewrite_evaluate_header(engine, urls[i], ANIXOPS_PHASE_RESPONSE, 0, NULL, &header),
			ANIXOPS_OK);
		ANIXOPS_EXPECT_EQ_INT(header.action, actions[i]);
...
static void header_response_mutation_common_strict_fixture_rejects_missing_header_name(void)
{
	char *fixture = read_fixture("tests/fixtures/HeaderResponseMutation.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void loon_header_mutation_fixture_maps_header_rewrites(void)
{
	static const char *urls[] = {
		"https://header.loon.test/request-add/fast",
		"https://header.loon.test/request-regex",
		"https://header.loon.test/response-add/cache",
		"https://header.loon.test/response-drop"};
	static const anixops_phase_t phases[] = {
		ANIXOPS_PHASE_REQUEST,
		ANIXOPS_PHASE_REQUEST,
		ANIXOPS_PHASE_RESPONSE,
	...
	static const anixops_rewrite_action_t actions[] = {
		...
		ANIXOPS_REWRITE_RESPONSE_HEADER_ADD,
		ANIXOPS_REWRITE_RESPONSE_HEADER_DEL};
	static const char *current_values[] = {NULL, "old=Alpha", NULL, NULL};
	static const char *expected_names[] = {
		"X-Loon-Trace",
		"X-Loon-Token",
		"X-Loon-Trace",
		"Set-Cookie"};
	static const char *expected_values[] = {"trace-fast", "new=Alpha", "resp-cache", ""};
	char *fixture = read_fixture("tests/fixtures/Loon.HeaderMutation.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_header_rewrite_result_t header;
	size_t i;
...
static void loon_header_mutation_malformed_fixture_rejects_invalid_header_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.HeaderMutation.Malformed.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void loon_response_rewrite_fixture_maps_response_echo_and_body(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.ResponseRewrite.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://response.loon.test/echo/item",
			ANIXOPS_PHASE_REQUEST,
			"original",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 200);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(body, "loon-item");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://response.loon.test/clean",
			ANIXOPS_PHASE_REQUEST,
			"ad=1&ok=1",
			body,
			sizeof(body),
...
static void loon_response_rewrite_malformed_fixture_rejects_invalid_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.ResponseRewrite.Malformed.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void quantumultx_response_rewrite_fixture_maps_response_echo_and_body(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseRewrite.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://response.qx.test/echo/item",
			ANIXOPS_PHASE_REQUEST,
			"original",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.status_code, 200);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.value, "qx-item");
	ANIXOPS_EXPECT_STREQ(body, "qx-item");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://response.qx.test/clean",
			ANIXOPS_PHASE_REQUEST,
			"ad=1&ok=1",
			body,
			sizeof(body),
...
static void quantumultx_response_rewrite_malformed_fixture_rejects_invalid_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/QuantumultX.ResponseRewrite.Malformed.snippet");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void surge_response_rewrite_fixture_maps_response_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.ResponseRewrite.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://response.surge.test/clean",
			ANIXOPS_PHASE_REQUEST,
			"ad=1&ok=1",
			body,
			sizeof(body),
...
static void surge_response_rewrite_malformed_fixture_rejects_invalid_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Surge.ResponseRewrite.Malformed.sgmodule");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void body_request_json_mutation_common_fixture_maps_request_body_json_replace(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyRequestJsonMutation.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://json.body.mutation.test/request",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":false,\"name\":\"common\"}",
			body,
			sizeof(body),
			&rewrite),
		ANIXOPS_OK);
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.message, "json body rewritten");
	ANIXOPS_EXPECT_STREQ(body, "{\"enabled\":true,\"name\":\"common\"}");
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_NONE);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, -1);
	ANIXOPS_EXPECT_STREQ(body, "{\"enabled\":false,\"name\":\"common\"}");

	anixops_engine_free(engine);
	free(fixture);
}

static void body_request_json_mutation_common_strict_fixture_rejects_missing_json_path(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyRequestJsonMutation.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void body_json_mutation_common_fixture_maps_response_body_json_replace(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJsonMutation.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://json.body.mutation.test/response",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":false,\"name\":\"common\"}",
			body,
			sizeof(body),
...
static void body_json_mutation_common_strict_fixture_rejects_missing_json_path(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJsonMutation.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void body_jq_mutation_common_fixture_maps_request_and_response_body_jq(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJqMutation.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://jq.body.mutation.test/request",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":false}",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://jq.body.mutation.test/response",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":true}",
			body,
			sizeof(body),
...
static void body_jq_mutation_common_strict_fixture_rejects_missing_filter(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJqMutation.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void body_jq_alias_mutation_common_fixture_maps_http_request_and_response_jq(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJqAliasMutation.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://jq-alias.body.mutation.test/request",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":false}",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://jq-alias.body.mutation.test/response",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":true}",
			body,
			sizeof(body),
...
static void body_jq_alias_mutation_common_strict_fixture_rejects_missing_filter(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJqAliasMutation.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void body_jq_advanced_common_fixture_maps_filter_edges(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJqAdvanced.Common.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rewrite_result_t rewrite;
	char body[256];
	const char *urls[] = {
		"https://jq.advanced.body.mutation.test/predicate",
		"https://jq.advanced.body.mutation.test/slice",
		"https://jq.advanced.body.mutation.test/recursive",
		"https://jq.advanced.body.mutation.test/computed",
		"https://jq.advanced.body.mutation.test/delete",
		"https://jq.advanced.body.mutation.test/map",
		"https://jq.advanced.body.mutation.test/entries",
		"https://jq.advanced.body.mutation.test/walk",
		"https://jq.advanced.body.mutation.test/test",
		"https://jq.advanced.body.mutation.test/capture",
		"https://jq.advanced.body.mutation.test/assignment",
		"https://jq.advanced.body.mutation.test/iterator"
	};
	const char *inputs[] = {
		"{\"items\":[{\"name\":\"disabled\",\"enabled\":false},{\"name\":\"enabled\",\"enabled\":true}]}",
		"{\"items\":[1,2,3,4]}",
		"{\"name\":\"root\",\"nested\":{\"name\":\"child\"}}",
		"{\"items\":[{\"name\":\"alpha\",\"value\":1},{\"name\":\"beta\",\"value\":2}]}",
		"{\"items\":[{\"name\":\"alpha\"},{\"name\":\"beta\"}],\"secret\":\"remove\"}",
		"{\"items\":[{\"name\":\"alpha\"},{\"name\":\"beta\"}]}",
		"{\"keep\":1,\"drop\":2}",
		"{\"name\":\"alpha\",\"nested\":{\"name\":\"beta\"}}",
		"{\"name\":\"ABC\"}",
		"{\"path\":\"alice/42\"}",
	...
	ANIXOPS_EXPECT_EQ_INT(anixops_engine_load_config(engine, fixture), ANIXOPS_OK);
	ANIXOPS_EXPECT_EQ_SIZE(anixops_engine_rewrite_rule_count(engine), 12);
	ANIXOPS_EXPECT_EQ_SIZE(anixops_engine_rule_diagnostic_count(engine), 12);
	for (i = 0; i < 12; i++) {
		ANIXOPS_EXPECT_EQ_INT(
			anixops_rewrite_apply_body(
				engine,
...
#if defined(ANIXOPS_ENABLE_LIBJQ)
		ANIXOPS_EXPECT_STREQ(rewrite.message, "jq body rewritten");
		ANIXOPS_EXPECT_STREQ(body, expected[i]);
#else
		ANIXOPS_EXPECT_STREQ(rewrite.message, "jq backend unavailable");
		ANIXOPS_EXPECT_STREQ(body, inputs[i]);
#endif
	}
...
static void body_jq_advanced_common_strict_fixture_rejects_missing_filter(void)
{
	char *fixture = read_fixture("tests/fixtures/BodyJqAdvanced.Common.Malformed.conf");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void loon_body_mutation_fixture_maps_body_rewrites(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.BodyMutation.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body.loon.test/request/item",
			ANIXOPS_PHASE_REQUEST,
			"token=Alpha",
			body,
			sizeof(body),
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_REQUEST_BODY_REPLACE_REGEX);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(body, "token=Alpha-loon");
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_NONE);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, -1);
	ANIXOPS_EXPECT_STREQ(body, "token=Alpha");

	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body.loon.test/response/item",
			ANIXOPS_PHASE_RESPONSE,
			"ad=1&ok=1",
			body,
			sizeof(body),
...
static void loon_body_mutation_malformed_fixture_rejects_invalid_body_regex(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.BodyMutation.Malformed.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void loon_body_json_mutation_fixture_maps_request_body_json_replace(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.BodyJsonMutation.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body-json.loon.test/profile",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":false,\"name\":\"loon\"}",
			body,
			sizeof(body),
			&rewrite),
		ANIXOPS_OK);
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, 0);
	ANIXOPS_EXPECT_STREQ(rewrite.message, "json body rewritten");
	ANIXOPS_EXPECT_STREQ(body, "{\"enabled\":true,\"name\":\"loon\"}");
	...
	ANIXOPS_EXPECT_EQ_INT(rewrite.action, ANIXOPS_REWRITE_NONE);
	ANIXOPS_EXPECT_EQ_INT(rewrite.rule_index, -1);
	ANIXOPS_EXPECT_STREQ(body, "{\"enabled\":false,\"name\":\"loon\"}");

	anixops_engine_free(engine);
	free(fixture);
}

static void loon_body_json_mutation_malformed_fixture_rejects_missing_json_path(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.BodyJsonMutation.Malformed.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
static void loon_response_body_json_mutation_fixture_maps_response_body_json_replace(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.ResponseBodyJsonMutation.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	anixops_rewrite_result_t rewrite;
	char body[128];
	...
	ANIXOPS_EXPECT_EQ_INT(
		anixops_rewrite_apply_body(
			engine,
			"https://body-json.loon.test/response",
			ANIXOPS_PHASE_REQUEST,
			"{\"enabled\":false,\"name\":\"loon\"}",
			body,
			sizeof(body),
...
static void loon_response_body_json_mutation_malformed_fixture_rejects_missing_json_path(void)
{
	char *fixture = read_fixture("tests/fixtures/Loon.ResponseBodyJsonMutation.Malformed.plugin");
	anixops_engine_t *engine = anixops_engine_new();
	anixops_rule_diagnostic_t diagnostic;
	int status = 0;
	size_t line = 0;
...
void anixops_register_config_tests(anixops_test_case_t *tests, size_t *count, size_t cap)
{
	...
	add_test(
		...
		quantumultx_request_header_mutation_fixture_maps_request_header_regex);
	add_test(
		tests,
		count,
		cap,
		"config/quantumultx_request_header_mutation_malformed_fixture_rejects_invalid_regex",
		quantumultx_request_header_mutation_malformed_fixture_rejects_invalid_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		surge_body_mutation_fixture_maps_response_body_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		surge_body_jq_mutation_fixture_maps_request_and_response_jq);
	add_test(
		tests,
		count,
		cap,
		"config/surge_body_jq_mutation_malformed_fixture_rejects_missing_filter",
		surge_body_jq_mutation_malformed_fixture_rejects_missing_filter);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		surge_header_mutation_fixture_maps_header_rewrites);
	add_test(
		tests,
		count,
		cap,
		"config/surge_header_mutation_malformed_fixture_rejects_invalid_header_regex",
		surge_header_mutation_malformed_fixture_rejects_invalid_header_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		request_rewrite_redirect_status_strict_fixture_rejects_unsupported_status);
	add_test(
		tests,
		count,
		cap,
		"config/loon_request_rewrite_fixture_maps_redirect_and_reject",
		loon_request_rewrite_fixture_maps_redirect_and_reject);
	add_test(
		tests,
		count,
		cap,
		"config/loon_request_rewrite_malformed_fixture_rejects_invalid_url_regex",
		loon_request_rewrite_malformed_fixture_rejects_invalid_url_regex);
	add_test(
		tests,
		count,
		cap,
		"config/quantumultx_request_rewrite_fixture_maps_redirect_and_reject",
		quantumultx_request_rewrite_fixture_maps_redirect_and_reject);
	add_test(
		tests,
		count,
		cap,
		"config/quantumultx_request_rewrite_malformed_fixture_rejects_invalid_url_regex",
		quantumultx_request_rewrite_malformed_fixture_rejects_invalid_url_regex);
	add_test(
		tests,
		count,
		cap,
		"config/surge_request_rewrite_fixture_maps_redirect_and_reject",
		surge_request_rewrite_fixture_maps_redirect_and_reject);
	add_test(
		tests,
		count,
		cap,
		"config/surge_request_rewrite_malformed_fixture_rejects_invalid_url_regex",
		surge_request_rewrite_malformed_fixture_rejects_invalid_url_regex);
	add_test(
		tests,
		count,
		cap,
		"config/shadowrocket_request_rewrite_fixture_maps_redirect_and_reject",
		shadowrocket_request_rewrite_fixture_maps_redirect_and_reject);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		shadowrocket_body_mutation_fixture_maps_response_body_regex);
	add_test(
		tests,
		count,
		cap,
		"config/shadowrocket_body_mutation_malformed_fixture_rejects_invalid_regex",
		shadowrocket_body_mutation_malformed_fixture_rejects_invalid_regex);
	add_test(
		tests,
		count,
		cap,
		"config/shadowrocket_response_rewrite_fixture_maps_mock_response_body",
		shadowrocket_response_rewrite_fixture_maps_mock_response_body);
	add_test(
		tests,
		count,
		cap,
		"config/shadowrocket_response_rewrite_malformed_fixture_rejects_missing_body",
		shadowrocket_response_rewrite_malformed_fixture_rejects_missing_body);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		stash_url_rewrite_redirect_status_fixture_maps_portable_redirects);
	add_test(
		tests,
		count,
		cap,
		"config/stash_url_rewrite_redirect_status_malformed_fixture_rejects_invalid_regex",
		stash_url_rewrite_redirect_status_malformed_fixture_rejects_invalid_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		header_request_regex_mutation_common_fixture_maps_request_header_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		header_response_mutation_common_fixture_maps_response_header_add_replace);
	add_test(
		tests,
		count,
		cap,
		"config/header_response_mutation_common_strict_fixture_rejects_missing_header_name",
		header_response_mutation_common_strict_fixture_rejects_missing_header_name);
	add_test(
		tests,
		count,
		cap,
		"config/loon_header_mutation_fixture_maps_header_rewrites",
		loon_header_mutation_fixture_maps_header_rewrites);
	add_test(
		tests,
		count,
		cap,
		"config/loon_header_mutation_malformed_fixture_rejects_invalid_header_regex",
		loon_header_mutation_malformed_fixture_rejects_invalid_header_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		loon_response_rewrite_fixture_maps_response_echo_and_body);
	add_test(
		tests,
		count,
		cap,
		"config/loon_response_rewrite_malformed_fixture_rejects_invalid_body_regex",
		loon_response_rewrite_malformed_fixture_rejects_invalid_body_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		quantumultx_response_rewrite_malformed_fixture_rejects_invalid_body_regex);
	add_test(
		tests,
		count,
		cap,
	...
	add_test(
		...
		surge_response_rewrite_malformed_fixture_rejects_invalid_body_regex);
	add_test(
		tests,
		count,
		cap,
