...
- `test_abi.c`: ABI stability, null argument handling, lifecycle defaults.
- `test_config.c`: AnixOps config parsing and malformed input boundaries.
...
generic request/response script contract. It also runs the mihomo proxy-chain fixture when `MIHOMO_BIN` points to an
executable binary.
