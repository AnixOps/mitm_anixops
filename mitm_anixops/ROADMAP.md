...
The latest published stable artifact is `v1.2.3`. The `v1.1.x` train is
...
production-boundary evidence, SHA-256 digest/sidecar format semantics, and
release workflow run traceability.
